public class Day {
    ...
    // some sort of formula. Like if day 1 is heavy/high volume, day 2 will adjust to be easier. If the week is a deload-type
    // then the overall volume/weight will be less.
}
